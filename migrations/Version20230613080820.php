 ...
 */
final class Version20230613080820 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_1EA683CC5BE745AA ON Casting (IdentifiantRegion)');
        ...
        $this->addSql('CREATE TABLE PartenaireDiffusion (Entreprise NVARCHAR(50), Verifie BIT NOT NULL, Identifiant INT NOT NULL, PRIMARY KEY (Identifiant))');
        $this->addSql('CREATE TABLE Professionnel (Entreprise NVARCHAR(50), Verifie BIT NOT NULL, Identifiant INT NOT NULL, PRIMARY KEY (Identifiant))');
        $this->addSql('CREATE TABLE Region (Identifiant INT IDENTITY NOT NULL, nom NVARCHAR(255) NOT NULL, PRIMARY KEY (Identifiant))');
        ...
        $this->addSql('ALTER TABLE Casting ADD CONSTRAINT FK_1EA683CC5BE745AA FOREIGN KEY (IdentifiantRegion) REFERENCES Region (Identifiant)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Casting DROP CONSTRAINT FK_1EA683CC5BE745AA');
